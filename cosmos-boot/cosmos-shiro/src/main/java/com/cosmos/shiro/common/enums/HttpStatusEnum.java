 ...
 * @Package: com.cosmos.shiro.common.http
...
public enum HttpStatusEnum {
    ...
    public boolean is1xxInformational() {
        return HttpStatusEnum.Series.INFORMATIONAL.equals(this.series());
    }

    public boolean is2xxSuccessful() {
        return HttpStatusEnum.Series.SUCCESSFUL.equals(this.series());
    }

    public boolean is3xxRedirection() {
        return HttpStatusEnum.Series.REDIRECTION.equals(this.series());
    }

    public boolean is4xxClientError() {
        return HttpStatusEnum.Series.CLIENT_ERROR.equals(this.series());
    }

    public boolean is5xxServerError() {
        return HttpStatusEnum.Series.SERVER_ERROR.equals(this.series());
    }
    ...
    public static enum Series {
        ...
        public static HttpStatusEnum.Series valueOf(int status) {
