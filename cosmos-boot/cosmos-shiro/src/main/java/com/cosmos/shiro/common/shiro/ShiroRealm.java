package com.cosmos.shiro.common.shiro;
...
public class ShiroRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principalCollection) {
        ...
        SysUser sysUserEntity = (SysUser) principalCollection.getPrimaryPrincipal();
        ...
        for (SysRole sysRole : sysRoleList) {
            ...
            List<SysMenu> sysMenuEntityList = sysMenuService.selectSysMenuByRoleId(sysRole.getId());
